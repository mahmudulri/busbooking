...
class TripDetailsModel {
  ...
  TripDetailsModel({this.status, this.statusCode, this.success, this.body});
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
    ...
    branch: json["branch"] == null ? null : ItemBranch.fromJson(json["branch"]),
    ...
    seatPrices: json["seat_prices"] == null
        ? null
        : List<SeatPrice>.from(
            json["seat_prices"].map((x) => SeatPrice.fromJson(x)),
          ),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "bus": bus!.toJson(),
    "route": route!.toJson(),
    "seat_prices": List<dynamic>.from(seatPrices!.map((x) => x.toJson())),
  };
}
...
class BusBranch {
  ...
  final Type? vendorCommissionType;
  final String? status;
  final DateTime? createdAt;
  final DateTime? updatedAt;
