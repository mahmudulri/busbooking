...
CustomerBookingsModel customerBookingsModelFromJson(String str) =>
    CustomerBookingsModel.fromJson(json.decode(str));

String customerBookingsModelToJson(CustomerBookingsModel data) =>
    json.encode(data.toJson());

class CustomerBookingsModel {
  final String? status;
  final int? statusCode;
  final bool? success;
  final Body? body;

  CustomerBookingsModel({
    this.status,
    this.statusCode,
    this.success,
    this.body,
  ...
  factory CustomerBookingsModel.fromJson(Map<String, dynamic> json) =>
      CustomerBookingsModel(
        status: json["status"],
